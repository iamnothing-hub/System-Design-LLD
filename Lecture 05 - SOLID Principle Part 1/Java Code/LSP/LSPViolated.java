...
public class LSPViolated {
    public static void main(String[] args) {
        ...
        accounts.add(new com.lsp.follow.SavingAccount());
        accounts.add(new com.lsp.follow.CurrentAccount());
        accounts.add(new com.lsp.follow.FixedTermAccount());

        com.lsp.follow.BankClient client = new com.lsp.follow.BankClient(accounts);
        client.processTransactions(); // Throws exception when withdrawing from com.lsp.follow.FixedTermAccount
    }
}
