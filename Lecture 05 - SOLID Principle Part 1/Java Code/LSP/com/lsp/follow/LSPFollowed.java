package com.lsp.follow;

import java.util.ArrayList;
import java.util.List;

// 1. com.lsp.follow.DepositOnlyAccount interface: only allows deposits
interface DepositOnlyAccount {
    void deposit(double amount);
}

// 2. com.lsp.follow.WithdrawableAccount interface: allows deposits and withdrawals
